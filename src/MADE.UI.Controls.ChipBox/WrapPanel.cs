...
// See the LICENSE file in the Windows Community Toolkit project root for more information (https://github.com/CommunityToolkit/WindowsCommunityToolkit/blob/main/License.md).
...
namespace MADE.UI.Controls
{
    ...
    internal partial class WrapPanel : Panel
    {
        ...
        {
            get => (StretchChild)this.GetValue(StretchChildProperty);
            set => this.SetValue(StretchChildProperty, value);
        }
        ...
        private Size UpdateRows(Size availableSize)
        {
            ...
            Arrange(this.Children[lastIndex], this.StretchChild == StretchChild.Last);
        ...
        private struct UvMeasure
        {
            ...
            {
                return new UvMeasure { U = this.U + u, V = this.V + v };
            }

            public UvMeasure Add(UvMeasure measure)
            {
                return this.Add(measure.U, measure.V);
            }

            public Size ToSize(Orientation orientation)
            {
                return orientation == Orientation.Horizontal ? new Size(this.U, this.V) : new Size(this.V, this.U);
            }
        }
        ...
        private struct UvRect
        {
            ...
            public Rect ToRect(Orientation orientation)
            {
                ...
                {
                    Orientation.Vertical => new Rect(this.Position.V, this.Position.U, this.Size.V, this.Size.U),
                    Orientation.Horizontal => new Rect(this.Position.U, this.Position.V, this.Size.U, this.Size.V),
