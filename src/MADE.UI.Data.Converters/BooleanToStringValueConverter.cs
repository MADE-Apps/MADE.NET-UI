...
namespace MADE.UI.Data.Converters
{
    ...
    /// <summary>
    /// Defines a XAML value converter for converting from <see cref="bool"/> to <see cref="string"/>.
    /// </summary>
    public partial class BooleanToStringValueConverter : DependencyObject, IValueConverter, IValueConverter<bool, string>
    {
        ...
        /// <exception cref="InvalidDataConversionException">Thrown if the value converting back to is not known by the converter.</exception>
